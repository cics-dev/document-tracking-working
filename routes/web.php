...
Route::get('/offline/scores', [TetrisScoreController::class, 'index'])->name('offline.scores');
Route::post('/offline/scores', [TetrisScoreController::class, 'store'])->name('offline.scores.store');
