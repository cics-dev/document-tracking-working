...
class DocumentGenerationRule extends Model
{
    ...
    {
        return $this->belongsTo(DocumentType::class, 'source_document_type_id');
    }

    public function targetType()
    {
        return $this->belongsTo(DocumentType::class, 'target_document_type_id');
    }

    public function roles()
    {
        return $this->belongsToMany(Role::class, 'document_generation_rule_role');
    }
}
