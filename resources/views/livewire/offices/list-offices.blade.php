<section class="w-full">
    ...
    <div class="overflow-x-auto rounded-lg shadow-sm bg-white dark:bg-gray-800">
        <table class="border-spacing-y-2 text-sm text-left text-gray-700 dark:text-gray-200 w-full hidden md:table">
            ...
            <tbody>
                @forelse ($offices as $office)
                    <tr class="border-b dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-100 transition">
                            ...
                            <div class="flex justify-center">
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div class="flex justify-center">
                                        <button 
                                            @click="open = !open" 
                                            class="text-gray-600 dark:text-gray-200 focus:outline-none transition-all duration-200 rounded-full p-1 hover:bg-gray-200 dark:hover:bg-gray-600 hover:shadow-sm"
                                        >
        ...
        <div class="md:hidden space-y-4 p-2">
            @forelse ($offices as $office)
                <div class="border rounded-lg p-4 shadow-sm bg-white text-gray-900 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600">
                    ...
                    <div class="flex justify-end space-x-2">
                        <button wire:click="editOffice({{ $office->id }})" class="bg-green-500 text-white px-3 py-1 rounded-md hover:bg-green-600 dark:hover:bg-green-400 dark:hover:text-green-950 transition">Edit</button>
                        <button wire:click="deleteOffice({{ $office->id }})" class="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600 dark:hover:bg-red-400 dark:hover:text-red-950 transition">Delete</button>
                    </div>
                </div>
            @empty
