<div class="max-w-7xl mx-auto bg-white dark:bg-slate-950 rounded-xl shadow-[0_0_10px_0_rgba(0,0,0,0.5)] dark:shadow-[0_0_10px_0_rgba(255,255,255,0.08)] overflow-hidden p-6 relative text-gray-900 dark:text-black">
            ...
            <div class="flex items-center min-w-0 flex-1">
                ...
                <div class="min-w-0 flex-1">
                    <div class="flex justify-between items-center mb-1">
                        <p class="text-xs font-medium text-green-900 dark:text-black truncate file-name max-w-[120px]">filename.pdf</p>
                        <p class="text-xs text-green-700 dark:text-black upload-mb">0 MB / 0 MB</p>
                    </div>
                    ...
                    <div class="flex justify-between items-center mt-1">
                        <p class="text-xs text-green-700 dark:text-black">
                            <span class="upload-status">Preparing...</span>
                        </p>
                        <p class="text-xs text-green-700 dark:text-black upload-speed">0 MB/s</p>
                    </div>
                </div>
            </div>
            <button type="button" class="cancel-upload text-green-700 dark:text-black hover:text-green-900 dark:hover:text-green-300 p-1 ml-2">
    ...
    <div class="hidden" id="complete-template">
        <div class="flex items-center justify-between bg-green-50 dark:bg-slate-900/70 border border-green-200 dark:border-green-800 px-3 py-2 rounded-md mb-2">
            <div class="flex items-center min-w-0 flex-1">
                ...
                <div class="min-w-0">
                    <p class="text-xs font-medium text-green-900 dark:text-black truncate file-name">filename.pdf</p>
                    <p class="text-xs text-green-700 dark:text-black">Upload complete • <span class="file-size">0 MB</span></p>
                </div>
            </div>
            <button type="button" class="remove-file text-green-700 dark:text-black hover:text-green-900 dark:hover:text-green-300 p-1 ml-2">
    ...
    <div class="mb-8">
        <flux:heading size="xl" class="mb-4 border-b border-gray-200 dark:border-slate-700 pb-2 text-gray-900 dark:text-black">Document Details</flux:heading>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <flux:field>
                <flux:label class="dark:text-black">From <span class="text-red-500">*</span></flux:label>
                <flux:input 
                    wire:model.blur="document_from" 
                    placeholder="Enter sender..." 
                    type="text" 
                    class:input="dark:bg-slate-950 dark:text-black dark:border-slate-700"
                />
            </flux:field>

            <flux:field>
                <flux:label class="dark:text-black">To <span class="text-red-500">*</span></flux:label>
                <flux:select class="dark:bg-slate-950 dark:text-black dark:border-slate-700" wire:model="document_to_id" placeholder="Choose recipient..."
        ...
        <div class="mb-6">
            <flux:field>
                <flux:label class="dark:text-black">Subject <span class="text-red-500">*</span></flux:label>
                <flux:input 
        ...
        <div class="mb-8">
            <flux:field>
                <flux:label class="dark:text-black">
                    Attachment <span class="text-red-500">*</span> 
                    <span class="text-gray-400 dark:text-black font-normal text-xs ml-1">(Max 100MB)</span>
                </flux:label>

                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:bg-slate-900 dark:hover:bg-slate-800 transition-colors duration-200 mb-2">
                    <div class="flex flex-col items-center justify-center p-4 text-center">
                        <flux:icon icon="cloud-arrow-up" class="size-6 text-gray-500 dark:text-black mb-2" />
                        <p class="text-xs text-gray-700 dark:text-black mb-1">Click to upload or drag and drop</p>
                        <p class="text-xs text-gray-500 dark:text-black">
                    ...
                    @if ($attachment)
                        <div class="flex items-center justify-between bg-gray-50 dark:bg-slate-950 px-3 py-2 rounded-md border border-gray-200 dark:border-slate-700">
                            <div class="flex items-center min-w-0">
                                ...
                                @endphp
                                <div class="mr-2 flex-shrink-0 text-gray-400 dark:text-black">
                                    <flux:icon :icon="$icon" class="size-4" />
                                </div>
                                <div class="min-w-0">
                                    <p class="text-xs font-medium text-gray-900 dark:text-black truncate">
        ...
        <div class="flex justify-end items-center gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
